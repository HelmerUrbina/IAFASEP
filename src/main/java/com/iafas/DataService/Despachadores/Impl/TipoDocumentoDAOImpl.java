...
public class TipoDocumentoDAOImpl implements TipoDocumentoDAO {
    ...
    public List getListaTipoDocumento(BeanTipoDocumento objBeanTipoDocumento, String usuario) {
        ...
        sql = "SELECT NTIPO_DOCUMENTO_CODIGO, VTIPO_DOCUMENTO_DESCRIPCION, VTIPO_DOCUMENTO_ABREVIATURA "
        ...
        try {
            ...
            objBnMsgerr.setTabla("IAFAS_TIPO_DOCUMENTOS");
    ...
    public BeanTipoDocumento getTipoDocumento(BeanTipoDocumento objBeanTipoDocumento, String usuario) {
        sql = "SELECT VTIPO_DOCUMENTO_DESCRIPCION, VTIPO_DOCUMENTO_ABREVIATURA "
