...
public class CombosAjaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (mode) {
            ...
            case "PAACProcesos":
                request.setAttribute("objCombosAjax", objDsCombos.getPAACProcesos(periodo, presupuesto, request.getParameter("tipoCertificado")));
                break;
            case "idpCertificado":
            ...
            case "resolucionCertificacion":
                request.setAttribute("objCombosAjax", objDsCombos.getResolucionesCertificado(periodo, presupuesto,
            ...
            case "tareaCertificacion":
                request.setAttribute("objCombosAjax", objDsCombos.getTareaCertificado(periodo, presupuesto,
                        resolucion, request.getParameter("tipoCertificado"),
                        request.getParameter("solicitudCredito"), request.getParameter("informeDisponibilidad")));
                break;
            case "cadenaGastoCertificacion":
                request.setAttribute("objCombosAjax", objDsCombos.getCadenaGastoCertificado(periodo, presupuesto,
                        resolucion, request.getParameter("tarea"), request.getParameter("tipoCertificado"),
                        request.getParameter("solicitudCredito"), request.getParameter("informeDisponibilidad")));
                break;
            ...
            case "tipoNotaModificatoria":
                request.setAttribute("objCombosAjax", objDsCombos.getTipoNotaModificatoria());
                break;
            case "presupuestoNotaModificatoria":
                request.setAttribute("objCombosAjax", objDsCombos.getPresupuestoNotaModificatoria(periodo, request.getParameter("tipoNota"), request.getParameter("tipo")));
                break;
            case "resolucionNotaModificatoria":
                request.setAttribute("objCombosAjax", objDsCombos.getResolucionNotaModificatoria(periodo, request.getParameter("tipoNota"), request.getParameter("tipo"), presupuesto));
                break;
            case "tareaNotaModificatoria":
                request.setAttribute("objCombosAjax", objDsCombos.getTareaNotaModificatoria(periodo, request.getParameter("tipoNota"), request.getParameter("tipo"), presupuesto,
                        resolucion));
                break;
            case "cadenaGastoNotaModificatoria":
                request.setAttribute("objCombosAjax", objDsCombos.getCadenaGastoNotaModificatoria(periodo, request.getParameter("tipoNota"), request.getParameter("tipo"), presupuesto,
                        resolucion, request.getParameter("tarea")));
                break;
            //EJECUCION PRESUPUESTAL - NOTA MODIFICATORIA
