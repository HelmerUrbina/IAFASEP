 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "IduTareasPresupuestalesServlet", urlPatterns = {"/IduTareasPresupuestales"})
public class IduTareasPresupuestalesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int k = objDsTarea.iduTareasPresupuestales(objBnTarea, objUsuario.getUsuario());
        if (k != 0) {
        } else {
