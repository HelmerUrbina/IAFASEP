...
<head>
    ...
    <title>Finaliza Session - IAFAS EP</title>
...
<body oncontextmenu="return false" onkeydown="return false" topmargin="0" leftmargin="0">
    <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="100%" style="border: 1 solid #336699">
        ...
        <tr>
            <td width="100%" height="100%" rowspan="2"><p align="center" class="Estilo2">LA SESI&Oacute;N HA FINALIZADO.</span>
                <p align="center" class="Estilo2">
                <p align="center" class="Estilo4"><a href="FinalizaSesion" target="_parent">INICIAR SESI&Oacute;N</a>
            </td>
            <td width="20%"></td>
        </tr>
        <tr>
