...
<script type="text/javascript">
    ...
    var lista = new Array();
    <c:forEach var="d" items="${objPACProcesos}">
    ...
    $(document).ready(function () {
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                ...
                {text: 'DESCRIPCION', dataField: 'descripcion', editable: false, width: '30%', align: 'center', cellsAlign: 'left', cellclassname: cellclass, aggregates: [{'<b>Totales : </b>':
                                    function () {
                                        return  "";
                                    }}]},
                ...
                {text: 'TIPO PROC. CONT.', dataField: 'tipoProcesoContratacion', editable: false, filtertype: 'checkedlist', width: '12%', align: 'center', cellclassname: cellclass},
                {text: 'PROC. ETAPA', dataField: 'procesoEtapa', editable: false, filtertype: 'checkedlist', width: '10%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                {text: 'PROC. DOCUMENT.', dataField: 'procesoDocumento', editable: false, filtertype: 'checkedlist', width: '9%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                {text: 'TIPO PROCEDIMIENTO', dataField: 'tipoProcedimiento', editable: false, filtertype: 'checkedlist', width: '18%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
            ...
            if (codigo === null || codigo === '') {
                ...
                if ($.trim($(opcion).text()) === "Editar") {
                    ...
                    if (!isNaN(parseInt(certificado))) {
                        ...
                        fn_cargarComboAjax('#cbo_CompromisoAnual', {mode: 'compromisoAnualCertificado', periodo: periodo, presupuesto: presupuesto, codigo: certificado});
        ...
        $("#div_GrillaRegistro").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                editButtonDet.click(function (event) {
                    ...
                    if (indiceDetalle >= 0) {
                        $.ajax({
                            type: "GET",
                            url: "../PAACProcesos",
                            data: {mode: 'M', periodo: periodo, presupuesto: presupuesto, codigo: codigo, detalle: detalle},
                ...
                afectacionButtonDet.click(function (event) {
                    if (indiceDetalle >= 0) {
                        fn_cargarComboAjax("#cbo_TipoCalendarioContrato", {mode: 'tipoCalendarioCertificacion', periodo: periodo, presupuesto: presupuesto});
        ...
        $("#div_GrillaAfectacion").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                addButtonDet.click(function (event) {
                    ...
                    fn_cargarComboAjax("#cbo_Resolucion", {mode: 'resolucionNotaModificatoria', periodo: periodo, presupuesto: presupuesto, tipo: 'A', tipoNota: '005'});
                    $('#div_Importe').val(0);
            ...
            function _createElements() {
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $("#txt_Descripcion").jqxTooltip({content: '<b>DENOMINACION DEL BIEN O SERVICIO</b><br> <i>(Breve Descripción del Objeto de Contratación)</i>', position: 'mouse', name: 'movieTooltip'});
                        $("#div_ACompras").jqxCheckBox({width: 150});
                ...
                $('#div_VentanaRegistroContratoAfectacion').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#cbo_TipoCalendarioContrato').on('change', function () {
                            fn_cargarComboAjax("#cbo_ResolucionContrato", {mode: 'resolucionCertificacion', periodo: periodo, presupuesto: presupuesto,
                        ...
                        $('#cbo_ResolucionContrato').on('change', function () {
                            fn_cargarComboAjax("#cbo_DependenciaContrato", {mode: 'dependenciaCertificacion', periodo: periodo, presupuesto: presupuesto,
                        ...
                        $('#cbo_DependenciaContrato').on('change', function () {
                            fn_cargarComboAjax("#cbo_SecuenciaFuncionalContrato", {mode: 'secuenciaFuncionalCertificacion', periodo: periodo, presupuesto: presupuesto,
                        ...
                        $('#cbo_SecuenciaFuncionalContrato').on('change', function () {
                            fn_cargarComboAjax("#cbo_TareaContrato", {mode: 'tareaCertificacion', periodo: periodo, presupuesto: presupuesto,
                                tipoCalendario: $("#cbo_TipoCalendarioContrato").val(), resolucion: $("#cbo_ResolucionContrato").val(), dependencia: $("#cbo_DependenciaContrato").val(),
                        ...
                        $('#cbo_TareaContrato').on('change', function () {
                            fn_cargarComboAjax("#cbo_CadenaGastoContrato", {mode: 'cadenaGastoCertificacion', periodo: periodo, presupuesto: presupuesto,
                                tipoCalendario: $("#cbo_TipoCalendarioContrato").val(), resolucion: $("#cbo_ResolucionContrato").val(), dependencia: $("#cbo_DependenciaContrato").val(),
                ...
                $('#div_VentanaRegistroAfectacion').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $('#cbo_Resolucion').on('change', function () {
                            fn_cargarComboAjax("#cbo_TipoCalendario", {mode: 'tipoCalendarioNotaModificatoria', periodo: periodo, presupuesto: presupuesto, tipo: 'A', tipoNota: '005',
                        ...
                        $('#cbo_TipoCalendario').on('change', function () {
                            fn_cargarComboAjax("#cbo_Dependencia", {mode: 'dependenciaNotaModificatoria', periodo: periodo, presupuesto: presupuesto, tipo: 'A', tipoNota: '005',
                        ...
                        $('#cbo_Dependencia').on('change', function () {
                            fn_cargarComboAjax("#cbo_SecuenciaFuncional", {mode: 'secuenciaFuncionalNotaModificatoria', periodo: periodo, presupuesto: presupuesto, tipo: 'A', tipoNota: '005',
                        ...
                        $('#cbo_SecuenciaFuncional').on('change', function () {
                            fn_cargarComboAjax("#cbo_Tarea", {mode: 'tareaNotaModificatoria', periodo: periodo, presupuesto: presupuesto, tipo: 'A', tipoNota: '005',
                                tipoCalendario: $("#cbo_TipoCalendario").val(), resolucion: $("#cbo_Resolucion").val(), dependencia: $("#cbo_Dependencia").val(),
                        ...
                        $('#cbo_Tarea').on('change', function () {
                            fn_cargarComboAjax("#cbo_CadenaGasto", {mode: 'cadenaGastoNotaModificatoria', periodo: periodo, presupuesto: presupuesto, tipo: 'A', tipoNota: '005',
    ...
    function fn_CargarGrillaAfectacion() {
        ...
        $.ajax({
            type: "GET",
            url: "../PACProcesos",
            data: {mode: 'C', periodo: periodo, presupuesto: presupuesto, codigo: codigo},
            success: function (data) {
                data = data.replace("[", "");
                var fila = data.split("[");
                var rows = new Array();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dato.length === 19) {
                    ...
                    $("#cbo_TipoContratacion").jqxDropDownList('selectItem', dato[1]);
                    $("#cbo_ProcesoEtapa").jqxDropDownList('selectItem', dato[2]);
                    $("#cbo_ProcesoDocumento").jqxDropDownList('selectItem', dato[3]);
                    ...
                    $("#div_ACompras").val(parseInt(dato[18]));
    ...
    function fn_GrabarDatosDetalle() {
        ...
        $.ajax({
            ...
            data: {mode: modeDetalle, periodo: periodo, presupuesto: presupuesto, codigo: codigo, detalle: detalle,
...
<div id="div_VentanaPrincipal" style="display: none">
    ...
    <div style="overflow: hidden;">
        <form id="frm_PACProcesos" name="frm_PACProcesos" method="POST" >
            <table width="100%" border="0">
                <tr>
                    ...
                    <td class="inputlabel"><div id='div_ACompras'>A. Compras</div></div>
                </tr>
                <tr>
